...
def main() -> None:
    parser = argparse.ArgumentParser(description="Sandbox hit/bounce tuning")
    ...
    output_csv = args.out or str(project_root / "output" / "hit_bounce" / f"{video_id}_sandbox.csv")
