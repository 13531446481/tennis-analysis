...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.court_config_dir = current_dir / "court_configurations"
        self.court_config_dir.mkdir(parents=True, exist_ok=True)
        ...
        court_ref_path = self.court_config_dir / "court_reference.png"
        self.court = cv2.cvtColor(cv2.imread(str(court_ref_path)), cv2.COLOR_BGR2GRAY)
    ...
    def build_court_reference(self):
        ...
        court_ref_path = self.court_config_dir / "court_reference.png"
        plt.imsave(str(court_ref_path), court, cmap='gray')
        self.court = court
        return court
    ...
    def save_all_court_configurations(self):
        ...
        for i, conf in self.court_conf.items():
            ...
            output_path = self.court_config_dir / f"court_conf_{i}.png"
            cv2.imwrite(str(output_path), c)
